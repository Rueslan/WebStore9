...
namespace WebStore9.WebAPI.Controllers.Identity
{
    ...
    public class UsersApiController : ControllerBase
    {
        ...
        public UsersApiController(WebStore9DB db, ILogger<UsersApiController> logger)
        {
            _Logger = logger;
            _UserStore = new UserStore<User, Role, WebStore9DB>(db);
        }
        ...
        [HttpPost("Role/{role}")]
        public async Task AddToRoleAsync([FromBody] User user, string role, [FromServices] WebStore9DB db)
        {
        ...
        public async Task RemoveFromRoleAsync([FromBody] User user, string role, [FromServices] WebStore9DB db)
        {
        ...
        [HttpPost("AddClaims")]
        public async Task AddClaimsAsync([FromBody] AddClaimDTO ClaimInfo, [FromServices] WebStore9DB db)
        {
        ...
        public async Task ReplaceClaimAsync([FromBody] ReplaceClaimDTO ClaimInfo, [FromServices] WebStore9DB db)
        {
        ...
        public async Task RemoveClaimsAsync([FromBody] RemoveClaimDTO ClaimInfo, [FromServices] WebStore9DB db)
        {
        ...
        [HttpPost("AddLogin")]
        public async Task AddLoginAsync([FromBody] AddLoginDTO login, [FromServices] WebStore9DB db)
        {
        ...
        public async Task RemoveLoginAsync([FromBody] User user, string LoginProvider, string ProviderKey, [FromServices] WebStore9DB db)
        {
