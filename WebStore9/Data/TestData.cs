...
namespace WebStore9.Data
{
    public static class TestData
    {
        ...
        public static IEnumerable<Product> Products { get; } = new[]
        {
            ...
            new Product{ Id = 6, Name = "Легкое голубое поло", Price = 1025, ImageUrl="product6.jpg", Order = 5, SectionId = 1 },
            new Product{ Id = 7, Name = "Платье белое", Price = 1025, ImageUrl="product7.jpg", Order = 6, SectionId = 7 },
            new Product{ Id = 8, Name = "Костюм кролика", Price = 1025, ImageUrl="product8.jpg", Order = 7, SectionId = 7 },
            new Product{ Id = 9, Name = "Красное китайское платье", Price = 1025, ImageUrl="product9.jpg", Order = 8, SectionId = 18, BrandId = 2 },
            new Product{ Id = 10, Name = "Женские джинсы", Price = 1025, ImageUrl="product10.jpg", Order = 9, SectionId = 18 },
            new Product{ Id = 11, Name = "Джинсы женские", Price = 1025, ImageUrl="product11.jpg", Order = 10, SectionId = 20 },
            new Product{ Id = 12, Name = "Летний костюм", Price = 1025, ImageUrl="product12.jpg", Order = 11, SectionId = 20 },
        };
    }
}
